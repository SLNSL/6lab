...
public class ReplaceIfGreaterCommandServ implements Command {
    ...
    public ReplaceIfGreaterCommandServ(Collection collectionManager, Messenger messenger, ServerDataChecker serverDataChecker) {
    ...
    public Result<String> execute(int port, Object... args) throws IncorrectNumberOfArgumentsException {
        ...
        Result<Boolean> replaceOrNot = collectionManager.replaceIfGreater(key, product);
